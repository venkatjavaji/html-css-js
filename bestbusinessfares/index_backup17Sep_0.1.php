                        ...
                        <div class="table-responsive form-table container">
                            ...
                            <form name="quotation" id="quotation" class="form-group" action="email_handler.php"  method="post">
                                <table class="table-borderless">
                                    ...
                                    <tr>
                                        <td> <label for="npassengers"># of Passengers:</label>
                                        ...
                                        <td class="oner">
                                            <div class="form-group ui-widget">
                                                ...
                                                <input type="text" name="fromcity" id="fromcity" class="form-control input-sm autocomplete" placeholder="Auckland / AKL"/>
                                            </div>
                                        </td>
                                        <td class="oner">
                                            <div class="form-group ui-widget">
                                                <label for="tocity">To(city/airport code):</label>
                                                <input type="text" name="tocity" id="tocity" class="form-control input-sm autocomplete" placeholder="Dubai / DXB"/>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="oner">
                                        <td>
                                            ...
                                            <input   name="departuredate" id="departuredate" class="departuredate form-control datepicker input-sm" placeholder=""/>
                                        </td>
                                        <td>
                                            <label for="returndate">Return:</label>
                                            <input  type="text" name="returndate" id="returndate" class="returndate form-control datepicker input-sm" placeholder=""/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="multi1">
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="fromcity">From(city/airport code):</label>
                                                <input type="text" name="fromcity" id="fromcity1" class="form-control input-sm autocomplete " placeholder="From City"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="tocity">To(city/airport code):</label>
                                                <input type="text" name="tocity" id="tocity1" class="form-control input-sm autocomplete " placeholder="To City"/>
                                            </div>
                                        </td>

                                        <td style="display: block;margin-top: 0px;">
                                            <label for="departuredate">Departure:</label>
                                            <input   name="departuredate" id="departuredate1" class="departuredate form-control datepicker input-sm " placeholder="Departue Date"/>
                                        </td>
                                    ...
                                    <tr class="multi2">
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="fromcity">From(city/airport code):</label>
                                                <input type="text" name="fromcity" id="fromcity2" class="form-control input-sm autocomplete " placeholder="Departue Date"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="tocity">To(city/airport code):</label>
                                                <input type="text" name="tocity" id="tocity2" class="form-control input-sm autocomplete " placeholder="To City"/>
                                            </div>
                                        </td>

                                        <td style="display: block;margin-top: 0px;">
                                            <label for="departuredate">Departure:</label>
                                            <input   name="departuredate" id="departuredate2" class="departuredate form-control datepicker input-sm " placeholder="Departue Date"/>
                                        </td>
                                    ...
                                    <tr class="multi3">
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="fromcity">From(city/airport code):</label>
                                                <input type="text" name="fromcity" id="fromcity3" class="form-control input-sm autocomplete" placeholder="From City"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="tocity">To(city/airport code):</label>
                                                <input type="text" name="tocity" id="tocity3" class="form-control input-sm autocomplete" placeholder="To City"/>
                                            </div>
                                        </td>

                                        <td style="display: block;margin-top: 0px;">
                                            <label for="departuredate">Departure:</label>
                                            <input   name="departuredate" id="departuredate3" class="form-control datepicker input-sm" placeholder="Departue Date"/>
                                        </td>
                                    ...
                                    <tr class="multi4">
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="fromcity">From(city/airport code):</label>
                                                <input type="text" name="fromcity" id="fromcity4" class="form-control input-sm autocomplete" placeholder="From City"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group ui-widget">
                                                <label for="tocity">To(city/airport code):</label>
                                                <input type="text" name="tocity" id="tocity4" class="form-control input-sm autocomplete" placeholder="To City"/>
                                            </div>
                                        </td>

                                        <td style="display: block;margin-top: 0px;">
                                            <label for="departuredate">Departure:</label>
                                            <input   name="departuredate" id="departuredate4" class="form-control datepicker input-sm" placeholder="Departue Date"/>
                                        </td>
                            ...
                            <div class="quote-right">
                                <h2>50-70% OFF</h2>
                                <h3>Business & First Class Tickets.</h3>
