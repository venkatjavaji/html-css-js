...
<html>
    ...
    <body>
        ...
        try {
            ...
            $mail->Host = "n3plcpnl0087.prod.ams3.secureserver.net"; // GODaddy SMTP server
            ...
            $mail->FromName = "GoBusinessFareTest";

            // $to = "javaji.venkat@gmail.com";
			$mail->AddReplyTo("sidhu396@gmail.com","GBF Support");
            ...
            $mail->Subject = "Greetings from Go Business Fares!!" . $myname ;
